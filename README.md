# Supplementary bioinformatics methods for "Morbidostat-Directed Experimental Evolution of Ciprofloxacin Resistance in Gram-negative Bacterial Pathogens" paper.
...
((R<sub>l</sub> + R<sub>r</sub>) / 2 * ( 1 + B<sub>min</sub> / A<sub>rlen</sub>)) / (Dt * ( 1 - mmatch / A<sub>rlen</sub> ))
